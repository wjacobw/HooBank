...
const Hero = () => (
  ...
  >
    ...
    >
      <div
        className="flex flex-column items-center py-[6px]
      ...
      <div className="flex flex-row justify-between items-center w-full">
        <h1
          className="flex-1 font-poppins font-semibold ss:text-[72px] text-ellipsis-[52px]
      ...
      <h1
        className="flex-1 font-poppins font-semibold ss:text-[68px] text-ellipsis-[52px]
    ...
    my:my-0 my-10 relative`}>
      <img src = {robot} alt = "billing" 
      className = "w-[100%] h-[100%] relative z-[5]"></img>
      <div className = "absolute z-[0] w-[40%] h-[35%] top-0 pink__gradient"></div>
      <div className = "absolute z-[1] w-[40%] h-[80%] top-0 white__gradient"></div>
      <div className = "absolute z-[0] w-[50%] h-[55%] bottom-20 blue__gradient"></div>
    </div>
